...
#define NORMALIZATION_ANGLE(angle) \
...
public:
  ...
  void SetWeights(VectorXd* weights_out);
  ...
  void UpdateState(MeasurementPackage meas_package, MatrixXd S, MatrixXd Tc,  VectorXd z_pred);
